...
// local include files
//
#include <Dbgl.h>	   // debug flags
#include <Vrbl.h>	   // debug flags
...
public:
  ...
  //
  static const long MAX_OPTVAL_SIZE = 399;
  ...
  static Vrbl verbosity_level_d;

  static const char* DEF_OPT_DBGL;
  static const char* DEF_OPT_VRBL;
  static const long DEF_POS_DBGL;
  static const long DEF_POS_VRBL;
...
private:
  ...
  // unique matching
  //
  long unique_match(const char* str);
};
